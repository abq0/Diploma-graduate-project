            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">تعديل عقار</h1>
                    </div>
                                        ...
                                        <form wire:submit.prevent="update">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <div class="row">
                                                        @foreach($images as $image)
                                                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 border-0">
                                                                <a wire:click="imageDelete({{$image['id']}})"
                                                                   class="btn btn-danger btn-sm m-2 position-absolute">
                                                                    <i class="fas fa-trash-alt"></i>
                                                                </a>
                                                                <img src="{{asset('storage/'.$image['image'])}}"
                                                                     class="rounded shadow-sm rounded w-100 h-100 img-thumbnail">
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="form-group col-12">
                                                    ...
                                                    <input class="form-control" type="file" wire:model="uploadedImages"
                                                           multiple="multiple">
